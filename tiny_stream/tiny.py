...
#Get object types
object_types = []
with open("dnn_model/object_types.txt", "r") as file_object:
...
while True:
    ...
    for class_id, score, bounds in zip(obj_id, scr, bx):
        ...
        detected_object_dict[i] = {"object_type": curr_obj, "bounding_box":bounds}
    ...
    try:
        print( requests.post("http://"+ip+":80/tiny_stream", files={'detected_objects': detected_object_dict, "number_of_person": number_of_person}))
